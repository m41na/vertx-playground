...
CREATE TABLE IF NOT EXISTS `tbl_app_event` (
...
CREATE TABLE IF NOT EXISTS `tbl_enum_col` (
...
CREATE TABLE IF NOT EXISTS `tbl_que_decor` (
...
CREATE TABLE IF NOT EXISTS `tbl_game_content` (
  `fk_game_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_msg_confirm_signup` (
...
CREATE TABLE IF NOT EXISTS `tbl_msg_invite_to_play` (
...
CREATE TABLE IF NOT EXISTS `tbl_msg_join_a_team` (
  `fk_player_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tbl_score_sheet` (
  `fk_player_id` int(11) NOT NULL,
  `fk_game_id` int(11) NOT NULL,
  `fk_que_id` int(11) NOT NULL,
